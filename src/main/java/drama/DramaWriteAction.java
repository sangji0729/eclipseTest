...
@WebServlet("/dramaWriteAction")
public class DramaWriteAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public DramaWriteAction() {
		super();
	}

	protected void doGet(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		RequestDispatcher rd = request.getRequestDispatcher("./dramaWrite.jsp");
