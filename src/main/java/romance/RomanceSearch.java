...
@WebServlet("/romanceSearch")
public class RomanceSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public RomanceSearch() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("./romanceSearch.jsp");
