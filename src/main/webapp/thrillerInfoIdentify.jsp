            ...
            <table id="myArticleList">
              ...
              <tr>
                ...
                <td class="articleTitle" colspan="9">
                  <a href="actionBoardDetail?tno=${l.tno }">${l.ttitle }</a>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td id="boardPage" colspan="9">
                  <div id="pageValueContainer">
                     ...
                     <c:otherwise>
                     <c:if test="${page > 5}">
                            <a href="./thrillerInfoIdentify?page=1" class="pageArrow">
                     ...
                     <c:if test="${startPage > 5}">
                            <a href="./thrillerInfoIdentify?page=${startPage - 5}" class="pageArrow">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                   <a href="./thrillerInfoIdentify?page=${i}" class="pageValue">${i}</a>
                                  </c:otherwise>
                               </c:choose>
                            </c:forEach>
                     ...
                     <c:when test="${totalPage - page >= totalPage-(totalPage / 5) * 5}">
                            <a href="./thrillerInfoIdentify?page=${totalPage }" class="pageArrow">
