          ...
          <c:forEach items="${list }" var="l">
              <tr>
                ...
                <td class="articleTitle">
                  <a href="dailyBoardDetail?dano=${l.dano }">글 번호 : ${l.dano }</a>
                </td>
              </tr>
              <tr>
                <td class="commentContent">
                  <c:set var="content" value="${l.daccontent } "/>
             ...
             <tr>
                     ...
                     <c:otherwise>
                     <c:if test="${page > 5}">
                            <a href="./dailyInfoCommentIdentify?page=1" class="pageArrow">
                     ...
                     <c:if test="${startPage > 5}">
                            <a href="./dailyInfoCommentIdentify?page=${startPage - 5}" class="pageArrow">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                   <a href="./dailyInfoCommentIdentify?page=${i}" class="pageValue">${i}</a>
                                  </c:otherwise>
                               </c:choose>
                            </c:forEach>
                     ...
                     <c:when test="${totalPage - page >= totalPage-(totalPage / 5) * 5}">
                            <a href="./dailyInfoCommentIdentify?page=${totalPage }" class="pageArrow">
