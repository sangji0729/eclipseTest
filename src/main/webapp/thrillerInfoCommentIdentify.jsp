          ...
          <c:forEach items="${list }" var="l">
              <tr>
                ...
                <td class="articleTitle">
                  <a href="thrillerBoardDetail?tno=${l.tno }">글 번호 : ${l.tno }</a>
                </td>
              </tr>
              <tr>
                <td class="commentContent">
                  <c:set var="content" value="${l.tccontent } "/>
             ...
             <tr>
                     ...
                     <c:otherwise>
                     <c:if test="${page > 5}">
                            <a href="./thrillerInfoCommentIdentify?page=1" class="pageArrow">
                     ...
                     <c:if test="${startPage > 5}">
                            <a href="./thrillerInfoCommentIdentify?page=${startPage - 5}" class="pageArrow">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                   <a href="./thrillerInfoCommentIdentify?page=${i}" class="pageValue">${i}</a>
                                  </c:otherwise>
                               </c:choose>
                            </c:forEach>
                     ...
                     <c:when test="${totalPage - page >= totalPage-(totalPage / 5) * 5}">
                            <a href="./thrillerInfoCommentIdentify?page=${totalPage }" class="pageArrow">
