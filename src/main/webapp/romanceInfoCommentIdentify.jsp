          ...
          <c:forEach items="${list }" var="l">
              <tr>
                ...
                <td class="articleTitle">
                  <a href="romanceBoardDetail?rno=${l.rno }">글 번호 : ${l.rno }</a>
                </td>
              </tr>
              <tr>
                <td class="commentContent">
                  <c:set var="content" value="${l.rccontent } "/>
             ...
             <tr>
                     ...
                     <c:otherwise>
                     <c:if test="${page > 5}">
                            <a href="./romanceInfoCommentIdentify?page=1" class="pageArrow">
                     ...
                     <c:if test="${startPage > 5}">
                            <a href="./romanceInfoCommentIdentify?page=${startPage - 5}" class="pageArrow">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                   <a href="./romanceInfoCommentIdentify?page=${i}" class="pageValue">${i}</a>
                                  </c:otherwise>
                               </c:choose>
                            </c:forEach>
                     ...
                     <c:when test="${totalPage - page >= totalPage-(totalPage / 5) * 5}">
                            <a href="./romanceInfoCommentIdentify?page=${totalPage }" class="pageArrow">
