...
<div id="writeFormContainer">
        ...
        <div id="titleInput">
            ...
            <input type="text" name="title" id="dtitle" value="${map.datitle}">
        </div>
        <div id="thumbnailInput">
            <span class="writeItem">썸네일</span><br>
            <c:choose>
				<c:when test="${map.dathumbnail ne null}">
				<a href="./thumbnail/${map.dathumbnail}">${map.dathumbnail}</a>&nbsp;&nbsp;
        ...
        <input type="hidden" name="dano" value="${param.dano}">
