            ...
            <table id="myArticleList">
              ...
              <tr>
                ...
                <td class="articleThumbnail" rowspan="3">
                  			<c:choose>
							<c:when test="${l.dathumbnail ne null}">
                            <img class="thumbnail" src="./thumbnail/${l.dathumbnail}" alt="thumbnail">
                            </c:when>
							<c:otherwise>
                ...
                <td class="articleTitle" colspan="9">
                  <a href="dailyBoardDetail?dano=${l.dano }">${l.datitle }</a>
                </td>
              </tr>
              <tr>
                <td class="articleContent" colspan="9">
                 <c:set var="content" value="${l.dacontent } "/>
              ...
              <tr>
                ...
                <td class="articleCount_Right">
                  <span class="articleCountText"> 조회수 </span>&nbsp;<span class="valueText">${l.dacount }</span>
                </td>
                ...
                <td class="articleLike_Right">
                  <span class="articleLikeText"> 추천 </span>&nbsp;<span class="valueText">${l.dalike }</span>
                </td>
              ...
              <tr>
                <td id="boardPage" colspan="9">
                  <div id="pageValueContainer">
                     ...
                     <c:otherwise>
                     <c:if test="${page > 5}">
                            <a href="./dailyInfoIdentify?page=1" class="pageArrow">
                     ...
                     <c:if test="${startPage > 5}">
                            <a href="./dailyInfoIdentify?page=${startPage - 5}" class="pageArrow">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                   <a href="./dailyInfoIdentify?page=${i}" class="pageValue">${i}</a>
                                  </c:otherwise>
                               </c:choose>
                            </c:forEach>
                     ...
                     <c:when test="${totalPage - page >= totalPage-(totalPage / 5) * 5}">
                            <a href="./dailyInfoIdentify?page=${totalPage }" class="pageArrow">
