            ...
            <table id="myArticleList">
              ...
              <tr>
                ...
                <td class="articleThumbnail" rowspan="3">
                            ...
                            <img class="thumbnail" src="./thumbnail/${l.rthumbnail}" alt="thumbnail">
                            </c:when>
							<c:otherwise>
                ...
                <td class="articleTitle" colspan="9">
                  <a href="romanceBoardDetail?rno=${l.rno }">${l.rtitle }</a>
                </td>
              </tr>
              <tr>
                <td class="articleContent" colspan="9">
                 <c:set var="content" value="${l.rcontent } "/>
              ...
              <tr>
                ...
                <td class="articleCount_Right">
                  <span class="articleCountText"> 조회수 </span>&nbsp;<span class="valueText">${l.rcount }</span>
                </td>
                ...
                <td class="articleLike_Right">
                  <span class="articleLikeText"> 추천 </span>&nbsp;<span class="valueText">${l.rlike }</span>
                </td>
              ...
              <tr>
                <td id="boardPage" colspan="9">
                  <div id="pageValueContainer">
                     ...
                     <c:otherwise>
                     <c:if test="${page > 5}">
                            <a href="./romanceInfoIdentify?page=1" class="pageArrow">
                     ...
                     <c:if test="${startPage > 5}">
                            <a href="./romanceInfoIdentify?page=${startPage - 5}" class="pageArrow">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                   <a href="./romanceInfoIdentify?page=${i}" class="pageValue">${i}</a>
                                  </c:otherwise>
                               </c:choose>
                            </c:forEach>
                     ...
                     <c:when test="${totalPage - page >= totalPage-(totalPage / 5) * 5}">
                            <a href="./romanceInfoIdentify?page=${totalPage }" class="pageArrow">
