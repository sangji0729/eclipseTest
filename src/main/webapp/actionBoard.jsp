           ...
           <!-- 검색창 -->
            <div id="searchBarBox">
				...
				<select name="searchColumn" id="searchColumn">
					<option value="atitle"
						<c:out value="${requestScope.searchColumn == 'atitle'? 'selected':''}"/>>제목</option>
					<option value="acontent"
						<c:out value="${requestScope.searchColumn == 'acontent'? 'selected':''}"/>>내용</option>
					<option value="name"
        ...
        <div id="boardListContainer">
            ...
            <c:forEach items="${list }" var="l" >
                    ...
                    <tr>
                     ...
                     <c:otherwise>
                     <c:if test="${page > 5}">
                            <a href="./actionBoard?page=1" class="pageArrow">
                     ...
                     <c:if test="${startPage > 5}">
                            <a href="./actionBoard?page=${startPage - 5}" class="pageArrow">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                   <a href="./actionBoard?page=${i}" class="pageValue">${i}</a>
                                  </c:otherwise>
                               </c:choose>
                            </c:forEach>
                     ...
                     <c:when test="${totalPage - page >= totalPage-(totalPage / 5) * 5}">
                            <a href="./actionBoard?page=${totalPage }" class="pageArrow">
