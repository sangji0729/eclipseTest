            ...
            <table id="myArticleList">
              ...
              <tr>
                ...
                <td class="articleThumbnail" rowspan="3">
                  			<c:choose>
							<c:when test="${l.fthumbnail ne null}">
                            <img class="thumbnail" src="./thumbnail/${l.fthumbnail}" alt="thumbnail">
                            </c:when>
							<c:otherwise>
                ...
                <td class="articleTitle" colspan="9">
                  <a href="fantasyBoardDetail?fno=${l.fno }">${l.ftitle }</a>
                </td>
              </tr>
              <tr>
                <td class="articleContent" colspan="9">
                 <c:set var="content" value="${l.fcontent } "/>
              ...
              <tr>
                ...
                <td class="articleCount_Right">
                  <span class="articleCountText"> 조회수 </span>&nbsp;<span class="valueText">${l.fcount }</span>
                </td>
              ...
              <tr>
                <td id="boardPage" colspan="9">
                  <div id="pageValueContainer">
                     ...
                     <c:otherwise>
                     <c:if test="${page > 5}">
                            <a href="./fantasyInfoIdentify?page=1" class="pageArrow">
                     ...
                     <c:if test="${startPage > 5}">
                            <a href="./fantasyInfoIdentify?page=${startPage - 5}" class="pageArrow">
                            ...
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                               <c:choose>
                                  ...
                                  <c:otherwise>
                                   <a href="./fantasyInfoIdentify?page=${i}" class="pageValue">${i}</a>
                                  </c:otherwise>
                               </c:choose>
                            </c:forEach>
                     ...
                     <c:when test="${totalPage - page >= totalPage-(totalPage / 5) * 5}">
                            <a href="./fantasyInfoIdentify?page=${totalPage }" class="pageArrow">
